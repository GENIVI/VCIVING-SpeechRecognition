...
def convert_save_folder_to_eaves_folder(save_folder_path: str):
    ...
    abs_save_audio_folder_path = abs_save_folder_path + "/" + consts_recordings.SAVE_FOLDER_SUB_DIR_AUDIO_FILES
    if not os.path.isdir(abs_save_audio_folder_path):
        os.makedirs(abs_save_audio_folder_path)

    abs_save_transcriptions_folder_path = abs_save_folder_path + "/" + consts_recordings.SAVE_FOLDER_SUB_DIR_TRANSCRIPTIONS
...
def get_audio_file_names(eaves_folder_path, start_time, end_time):
    ...
    abs_audio_file_path = eaves_folder_path + "/" + consts_recordings.SAVE_FOLDER_SUB_DIR_AUDIO_FILES + "/" + str_start_time + "_" + str_end_time + "." + consts_recordings.AUDIO_FILE_FORMAT
    abs_transcription_file_path = eaves_folder_path + "/" + consts_recordings.SAVE_FOLDER_SUB_DIR_TRANSCRIPTIONS + "/" + str_start_time + "_" + str_end_time + "." + consts_recordings.TRANSCRIPTION_FILE_FORMAT
